...
export class DocumentService {
  ...
  async upload(params: {
    ...
    try {
      ...
      console.log(`📄 DocumentService: Iniciando upload de ${category}`);
      ...
      console.log(
        `✅ DocumentService: Upload concluído - ID: ${result.documentId}`
      );
  ...
  async validate(documentId: string, cpf?: string): Promise<ValidationResult> {
    try {
      console.log(`🔍 DocumentService: Validando documento ${documentId}`);
      ...
      console.log(
        `✅ DocumentService: Documento ${documentId} validado com sucesso`
      );
  ...
  async delete(
    ...
    try {
      console.log(`🗑️ DocumentService: Excluindo documento ${documentId}`);
      ...
      console.log(`✅ DocumentService: Documento ${documentId} excluído`);
  ...
  async getDocumentsByUser(
    ...
    try {
      console.log(
        `📋 DocumentService: Buscando documentos do usuário ${userId}`
      );
