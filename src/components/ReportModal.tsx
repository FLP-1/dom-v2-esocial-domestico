      ...
      <Form onSubmit={handleSubmit}>
        <FormRow>
          <FormGroup>
            ...
            {errors['mesInicio'] && (
              <ErrorMessage>{errors['mesInicio']}</ErrorMessage>
            )}
          </FormGroup>
          ...
          <FormGroup>
            ...
            {errors['mesFim'] && (
              <ErrorMessage>{errors['mesFim']}</ErrorMessage>
            )}
          </FormGroup>
        </FormRow>
        ...
        <FormGroup>
          <Label>Relatórios a Gerar *</Label>
          <CheckboxContainer>
            {availableReports.map(report => (
              <CheckboxItem key={report.id}>
                <input
                  type='checkbox'
                ...
                />
                <CheckboxContent>
                  <CheckboxLabel>{report.nome}</CheckboxLabel>
          ...
          {errors['reports'] && (
            <ErrorMessage>{errors['reports']}</ErrorMessage>
          )}
          <HelpText>Selecione um ou mais relatórios para gerar</HelpText>
        </FormGroup>
      </Form>
    </SimpleModal>
  );
