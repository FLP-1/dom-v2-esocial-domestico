  ...
  try {
    ...
    if (testType === 'email' || testType === 'all') {
      ...
      if (!email) {
        ...
        try {
          console.log('🔄 Testando Twilio SendGrid...');
        ...
        try {
          console.log('🔄 Testando EmailService híbrido...');
    ...
    if (testType === 'config' || testType === 'all') {
      ...
      const twilioSmsConfig = {
        ...
        fallbackSid: 'SEU_ACCOUNT_SID_AQUI',
        fallbackToken: 'SEU_AUTH_TOKEN_AQUI',
        fallbackPhone: '+12183668060',
      };
