...
export default async function handler(
  ...
  try {
    ...
    console.log('✅ S-1000 enviado com sucesso!');
    ...
    console.log('📤 Tentando S-2200 para obter dados da empregada...');
    try {
      ...
      console.log('❌ S-2200 falhou:', error);
    }
...
function extrairDadosEmpregadorS1000(responseData: any): any {
  try {
    console.log('📋 Extraindo dados cadastrais do empregador...');
    ...
    console.log('✅ Dados cadastrais do empregador extraídos com sucesso');
    return dadosExtraidos;
  } catch (error) {
    console.log('⚠️ Erro ao extrair dados do empregador:', error);
    return {
      cpf: '59876913700',
...
async function tentarEnviarS2200(
  ...
  try {
    console.log('🧪 Tentando enviar S-2200...');
