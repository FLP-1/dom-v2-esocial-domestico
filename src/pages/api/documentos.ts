...
export default async function handler(
  ...
  if (req.method === 'GET') {
    try {
      ...
      console.log(`📋 API Documentos - Listando documentos`);
      console.log(
        `Filtros: userId=${userId}, category=${category}, validated=${validated}`
      );
    ...
    try {
      ...
      console.log(`🗑️ API Documentos - Excluindo documento: ${documentId}`);
