...
export default async function handler(
  ...
  try {
    ...
    console.log(`📝 Enviando S-1000 para ${environment.toUpperCase()}...`);
    try {
    ...
    if (eventoSucesso) {
      console.log(
        `🔍 Consultando status do lote em ${environment.toUpperCase()}...`
      );
      try {
    ...
    console.log(
      `🔍 Verificando se o cadastro foi processado em ${environment.toUpperCase()}...`
    );
    try {
