...
export default async function handler(
  ...
  try {
    ...
    try {
      console.log(`🔍 Testando resolução DNS detalhada para ${targetHost}...`);
    ...
    try {
      console.log(
        `🔒 Testando conectividade HTTPS avançada para ${targetHost}...`
      );
    ...
    try {
      console.log(`📄 Testando acesso ao WSDL via Axios...`);
    ...
    try {
      console.log(`🔗 Testando acesso ao endpoint via Axios...`);
    ...
    try {
      console.log(`🛣️ Testando rota de rede detalhada...`);
    ...
    try {
      console.log(`⚙️ Testando configuração DNS local...`);
