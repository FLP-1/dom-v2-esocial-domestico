...
export default async function handler(
  ...
  try {
    ...
    try {
      console.log(`🔐 Testando carregamento de certificado...`);
    ...
    try {
      console.log(`🏢 Testando consulta de empregador...`);
    ...
    try {
      console.log(`👤 Testando consulta de trabalhador...`);
    ...
    try {
      console.log(`📄 Testando validação de WSDLs...`);
