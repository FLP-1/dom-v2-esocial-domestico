...
export default async function handler(
  ...
  try {
    console.log(`🎯 CONSULTANDO TODAS AS FONTES OFICIAIS DISPONÍVEIS`);
    console.log(`🏢 Empregador: ${cpfEmpregador}`);
    console.log(`👤 Empregado: ${cpfEmpregado || '38645446880 (Erika)'}`);
    ...
    console.log('🏢 === CONSULTANDO DADOS DO EMPREGADOR ===');
    ...
    // === CONSULTAR EMPREGADO ===
    console.log('👤 === CONSULTANDO DADOS DO EMPREGADO ===');
