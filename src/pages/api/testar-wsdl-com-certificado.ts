...
export default async function handler(
  ...
  try {
    console.log('🔐 === TESTANDO WSDL COM CERTIFICADO eCPF ===');
    ...
    console.log('✅ Certificado eCPF carregado via ESocialSoapReal');
    ...
    for (const wsdl of wsdlsParaTestar) {
      ...
      try {
        ...
        if (resultado.sucesso) {
          console.log(
            `✅ WSDL acessível! Tamanho: ${resultado.conteudo?.length} chars`
          );
        } else {
