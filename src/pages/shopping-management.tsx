...
const ActionButtonSmall = styled.button<{
  ...
  transition: all 0.3s ease;
  background: ${props =>
    props.$variant === 'danger' ? '#e74c3c' : props.$theme.colors.primary};
  color: white;
...
const ItemActionButton = styled.button<{ $theme: any }>`
  width: 28px;
  height: 28px;
  border-radius: 6px;
  border: none;
...
export default function ShoppingManagement() {
  ...
  const categories: ShoppingCategory[] = [
    { id: '1', name: 'Supermercado', color: '#3498db', icon: '🛒' },
    { id: '2', name: 'Farmácia', color: '#e74c3c', icon: '💊' },
