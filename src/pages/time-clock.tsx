...
const UnifiedButtons = styled.div`
  display: flex;
  gap: 1rem;
...
// UnifiedButton component removed - now using reusable UnifiedButton component

// UnifiedModal components removed - now using reusable UnifiedModal component
...
export default function TimeClock() {
  ...
  const openUnifiedModal = (type: 'history' | 'details' | 'break') => {
